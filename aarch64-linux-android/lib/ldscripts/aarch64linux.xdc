...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("=/home/sabermod/tmp/aarch64-linux-android-4.9/aarch64-linux-android/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/home/sabermod/tmp/aarch64-linux-android-4.9/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
